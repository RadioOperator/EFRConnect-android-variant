...
![alt text](https://github.com/RadioOperator/EFRConnect-android-variant/blob/master/Screenshot-1.jpg)

## Services Page, display MAC address and added DFU button:
![alt text](https://github.com/RadioOperator/EFRConnect-android-variant/blob/master/Screenshot-2.jpg)

## DFU dialog, auto back to Browser page, no need to press OK:
![alt text](https://github.com/RadioOperator/EFRConnect-android-variant/blob/master/Screenshot-3.jpg)
